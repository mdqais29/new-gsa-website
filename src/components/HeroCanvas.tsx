      ...
      >
        ...
        <div className="relative z-10 w-full max-w-xl lg:max-w-2xl text-left drop-shadow-[0_8px_30px_rgba(0,0,0,1)]">
          ...
          <p className="text-xs sm:text-sm md:text-base lg:text-lg text-slate-200 max-w-xl mb-3 sm:mb-7 font-normal leading-relaxed">
            Get certified in recognized programs including Advanced Diploma in Construction Safety, Industrial Safety, OSHA, IOSH, and Diploma in Fire Safety. Unlock high-paying safety careers in India and abroad with dedicated job guidance.
          </p>
